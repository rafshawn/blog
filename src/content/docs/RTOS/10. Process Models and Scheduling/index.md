---
title: 10. Process Models and Scheduling
description: "Simple models and process execution"
...
## Process Creation
![process_creation.png](assets/process_creation.png){width=200px}
...
## Process Termination
![process_termination.png](assets/process_termination.png){width=200px}
...
## Queueing Model
![queueing_model.png](assets/queueing_model.png){width=400px}
...
- In this model, a process is either actively running, or has been terminated.
	![two-state_model-01.png](assets/two-state_model-01.png){width=500px}
	![two-state_model-02.png](assets/two-state_model-02.png){width=500px}

## Five-state model:
![five-state_model.png](assets/five-state_model.png){width=600px}
...
## Seven-state model:
![seven-state_model.png](assets/seven-state_model.png){width=600px}
