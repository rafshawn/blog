---
title: 18. FAT filesystem
description: "The venerable FAT filesystem"
...
![fat_system.png](assets/fat_system.png){width=500px}
...
# Block Structures
![block_structures.png](assets/block_structures.png){width=350px}
...
![linked_lists.png](assets/linked_lists.png){width=400px}
...
- **Assume list of blocks**:
	- ![list_of_blocks.png](assets/list_of_blocks.png){width=200px}
	- Accessing third block of file (cluster 6) requires iteration
- **Related question**:
	- ![pointer_where.png](assets/pointer_where.png){width=300px}
	- Where to store the pointers?

## File Allocation Table
![fat.png](assets/fat.png){width=300px}
